...
*/
#include <rock_paper_scissors_inferencing.h>
...
httpd_handle_t camera_httpd = NULL; //Handle to newly created instance of the server
httpd_handle_t stream_httpd = NULL;

const char* ssid = "LAPTOP-VOC3SGGK 1146";
const char* password = "obj_detected";
...
void classify()
{
  ...
  // Feed signal to the classifier and run classifier
...
void startCameraServer() {
  ...
  httpd_uri_t capture_uri = { 
    ...
    .user_ctx  = NULL               //pointer to user context data
  };
